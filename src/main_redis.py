...
from readers.RedisReader import RedisReader
from utils import configureLogging


def main(config: ConfigParser) -> None:
    # Train
    trainData = RedisReader().read()
    ivfadc = IVFADC(
        nearestCoarseNeighborsSearched=config.getint("ivfadc", "coarseNeighborsLookup"),
    ...
    # Search queries
    queryData = RedisReader().read()[:100]
